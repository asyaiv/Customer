...
Note: *The database is a AWS instance. Unfortunately it is impossible to have the database reset automatically on a scheduled base due to hosting arrangement, thus if you require a reset please don’t hesitate to request a reset.* 
